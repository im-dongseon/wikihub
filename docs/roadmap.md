...
| 그룹 | feature_id | 결과 |
|---|---|---|
| v0.1.16 | lint Step 0 race 가드 재설계(#180) · alias 중복 오탐(#176) · graphify openai endpoint(#177) · install.sh 프로필 config 정합(#182) · unit template `WIKIHUB_SRC`(#183) | ✅ release (2026-09-21) |
| v0.1.15 | `lint_ingest_chmod_644`(#160) · `fix_issue_162` | ✅ release (2026-07-07) |
